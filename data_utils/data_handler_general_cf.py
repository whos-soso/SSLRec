...
class DataHandlerGeneralCF:
	def __init__(self):
		if configs['data']['name'] == 'yelp':
			predir = '/kaggle/working/SSLRec/datasets/general_cf/sparse_yelp/'
		elif configs['data']['name'] == 'gowalla':
			predir = '/kaggle/working/SSLRec/datasets/general_cf/sparse_gowalla/'
		elif configs['data']['name'] == 'amazon':
			predir = '/kaggle/working/SSLRec/datasets/general_cf/sparse_amazon/'
		...
		elif configs['data']['name'] == 'LLM_steam':
			predir = '/kaggle/working/SSLRec/datasets/general_cf/LLM_steam/'
		elif configs['data']['name'] == 'LLM_yelp':
			predir = '/kaggle/working/SSLRec/datasets/general_cf/LLM_yelp/'
